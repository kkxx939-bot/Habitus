...
from habitus.infrastructure.store.contracts.lock import LockLostError, LockStoreSnapshot, LockToken

_PROCESS_COORDINATION_DOMAIN = f"process:{uuid.uuid4().hex}"
...
class ProcessLocalLockStore:
    ...
    def __init__(self) -> None:
        self.locks: dict[str, tuple[str, int, datetime, datetime]] = {}
    ...
    @property
    def coordination_domain(self) -> str:
        return _PROCESS_COORDINATION_DOMAIN
