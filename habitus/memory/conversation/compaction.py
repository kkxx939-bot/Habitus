...
from habitus.foundation.ids import canonical_path_identity, same_path_identity
from habitus.foundation.integrity import canonical_json
from habitus.infrastructure.store.contracts import LeaseGuard
...
from habitus.memory.compaction.field_ops import SemanticFieldOperationBatch
from habitus.memory.conversation.field_validation import summary_content_from_operations
...
from habitus.memory.conversation.summary import (
...
if TYPE_CHECKING:
    from habitus.memory.conversation.access import ConversationSummaryUseState
    from habitus.memory.conversation.indexing.model import ConversationSummaryReference
