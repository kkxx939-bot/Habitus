...
from habitus.memory.editor.extraction.model import MemoryExtractionResult
from habitus.memory.editor.mutation.model import MemoryMutationPlan
...
class MemoryIdentityPlanner:
    ...
    def plan(
        ...
        if not isinstance(extraction, MemoryExtractionResult):
            raise TypeError("extraction must be a validated MemoryExtractionResult")
