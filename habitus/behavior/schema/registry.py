...
from habitus.behavior.schema.fields import strict_mapping, validate_field
from habitus.behavior.schema.loader import load_schema
from habitus.behavior.schema.model import (
    BehaviorSchemaError,
    BehaviorSchemaMaterialization,
    BehaviorTypeSchema,
)
from habitus.behavior.schema.renderers import render_markdown
from habitus.behavior.schema.validators import validate_payload
...
class BehaviorSchemaRegistry:
    ...
    def load_default(cls) -> BehaviorSchemaRegistry:
        definitions = resources.files("habitus.behavior.schema.definitions")
        return cls(
            tuple(
