...
from habitus.benchmark.isolation import require_empty_directory
from habitus.benchmark.metrics import evidence_recall, latency_distribution
from habitus.benchmark.model import BenchmarkDataset, BenchmarkMessage, BenchmarkSession
    ...
    def __init__(
        ...
        *,
        ...
        if parsed.hostname is None or not _is_loopback_host(parsed.hostname):
            raise ValueError("unauthenticated HTTP benchmark server_url must use a loopback host")
        if (
