...
from habitus.benchmark.coverage import audit_dataset_coverage
from habitus.benchmark.datasets import load_dataset
from habitus.benchmark.evaluation import judge_answers
from habitus.benchmark.http_boundary import HTTPBoundaryBenchmark
from habitus.benchmark.lifecycle import LifecycleBenchmark
from habitus.benchmark.lifecycle_boundary import LifecycleBoundaryBenchmark
from habitus.benchmark.load import RuntimeLoadBenchmark
from habitus.benchmark.model import BenchmarkDataset, BenchmarkDatasetName, BenchmarkJudgeRecord
from habitus.benchmark.protocol import (
    OPENVIKING_PUBLIC_ANSWER_CONTEXT_CHARS,
    OPENVIKING_PUBLIC_RETRIEVAL_LIMIT,
    BenchmarkJudgePolicy,
)
from habitus.benchmark.recovery_boundary import RecoveryBoundaryBenchmark
...
from habitus.benchmark.runtime_boundary import RuntimeBoundaryBenchmark
from habitus.benchmark.vector import VectorBenchmarkRunner, load_vector_dataset
from habitus.benchmark.vector_boundary import VectorBoundaryBenchmark
from habitus.config import HabitusConfig


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        prog="python -m habitus.benchmark",
