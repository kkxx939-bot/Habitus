...
from habitus.benchmark.judge import BenchmarkJudge
from habitus.benchmark.model import BenchmarkAnswerRecord, BenchmarkDataset, BenchmarkJudgeRecord
from habitus.benchmark.protocol import BenchmarkJudgePolicy, resolve_judge_policy
from habitus.benchmark.runner import BenchmarkRunError, load_answer_records
...
def _answer_from_judge(value: Mapping[str, object]) -> BenchmarkAnswerRecord:
    from habitus.benchmark.runner import answer_record_from_mapping
