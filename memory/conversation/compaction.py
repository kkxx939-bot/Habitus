...
class ConversationSummaryCompactionPlan:
    ...
    def __post_init__(self) -> None:
        ...
        conversation_ids = {source.conversation_id for source in self.sources}
...
class ConversationRangeSummaryStore:
    ...
    def read(
        ...
        try:
            ...
            if (
                summary.conversation_id != address.conversation_id
    ...
    def create(
        ...
        if summary.conversation_id != address.conversation_id:
