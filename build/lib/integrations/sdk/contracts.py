...
class ServiceCapabilities:
    ...
    def __post_init__(self) -> None:
        _clean_text(self.api_version, "api_version")
        _clean_text(self.service_version, "service_version")
        for label, values in (("protocols", self.protocols), ("features", self.features)):
